...
export class UserWishlistComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var request = this.http.get<any>('http://127.0.0.1:8000/api/wishlist/' + this.wishlist_id, {observe: "body"})
    ...
    request.subscribe(data => {
      ...
      for (i = 0; i < this.products.length; i++) {
        ...
        var req2 = this.http.get('http://127.0.0.1:8000/api/products/' + this.products[i], {responseType: 'json'}) as Observable<Product>
